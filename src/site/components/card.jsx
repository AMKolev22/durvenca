    ...
    return(
        <a>
            <div id = "card" className="w-[45rem] h-[53rem] rounded-lg flex flex-col border-solid border-[0.3rem] font-extrabold relative" style={{borderColor: theme.color}}>
                ...
                <h2 className = "text-[2.4rem] pl-20 pt-4 font-semibold opacity-90 leading-snug whitespace-pre-wrap" style={ textstyle }>{theme.info} <span className="font-extrabold underline">{theme.highlight}</span></h2>
