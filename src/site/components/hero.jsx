...
export default function Hero(){
    ...
    return(
        <div className="w-screen h-screen overflow-hidden flex justify-center items-center bg-no-repeat" id = "hero" style={ background } data-aos-offset="15">
            <div className="flex items-center flex-col">
                ...
                <a className="text-[1.8rem] font-bold opacity-[0.95] block" id = "btn-outer" data-aos="fade-right" data-aos-duration="700" data-aos-offset="15"><p style= { buttonstyle } className="px-[5.8rem] py-4 rounded-[1rem] text-[1.8rem] font-semibold" id = "btn"><span class = "ml-[2.8rem]">PLAY</span></p></a>
            </div>
        </div>
    )
}